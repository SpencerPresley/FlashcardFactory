...
# Import our parsers
from backend.parsers import parse_document, PDFParser, DOCXParser, TXTParser, PPTXParser, BaseDocumentParser
...
def test_single_file_parsing():
    ...
    if not txt_path.exists():
        ...
        with open(txt_path, 'w') as f:
            f.write("This is a sample text file for testing the TXT parser.\nIt contains multiple lines.")
    ...
    if pdf_path.exists():
        ...
        assert pdf_text_direct == pdf_text_upload == pdf_text_class, "PDF parsing methods produced different results"
    ...
    if txt_path.exists():
        ...
        assert txt_text_direct == txt_text_upload, "TXT parsing methods produced different results"
    ...
    for upload_file in upload_files:
        try:
            ...
            if extracted_text:
                ...
                print(f"  Extracted {len(extracted_text)} chars: {extracted_text[:50]}...")
